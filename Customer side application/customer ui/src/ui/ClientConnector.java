...
public class ClientConnector {
     ...
     * @return Response from the server which can either be SUCCESS if the
     * withdrawing was successful, UNSUCCESSFULL if withdrawal was unsuccessful,
     * or an error message from the server
     * @throws IOException
     */
     ...
     * @return "EXIST" the customer exist "NOT FOUND" if customer not found else
     ...
     * @return the id number or "" if does not exist or an ERROR if there was an
     * error
     * @throws IOException
     */
